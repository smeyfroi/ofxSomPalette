...
meta:
	ADDON_NAME = ofxSomPalette
	ADDON_DESCRIPTION = Generate 2D palettes from three dimensional data
	ADDON_AUTHOR = @smeyfroi
	ADDON_TAGS = "addon"
	ADDON_URL = http://github.com/smeyfroi/ofxSomPalette

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxSelfOrganizingMap
